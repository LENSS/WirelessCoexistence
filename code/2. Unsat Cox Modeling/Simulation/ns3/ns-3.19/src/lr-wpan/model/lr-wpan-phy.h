...
#include "ns3/sw-spectrum-signal-parameters.h"
#include "ns3/mac16-address.h"
#include "lr-wpan-net-device.h"

/* co-existence addition */
...
typedef enum
{
  ...
  IEEE_802_15_4_PHY_COLLISION = 0xd
...
private:
  ...
  // The duration of transmission for each signal receieved by TRX
  Time duration;
  Time txDuration;
