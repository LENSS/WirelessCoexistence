...
typedef Callback< void, McpsDataIndicationParams, Ptr<Packet>, uint32_t > McpsDataIndicationCallback;
...
private:
  ...
  uint32_t m_pktNum;
  uint32_t m_pktNumSuc;
  uint32_t m_cummQsize;
  Time m_sendTime;
  Time m_cummDelay;
