 ...
 */
#ifndef FULL_YANS_WIFI_HELPER_H
#define FULL_YANS_WIFI_HELPER_H
 ...
 */
class FullYansWifiChannelHelper
{
public:
  /**
   ...
   */
  static FullYansWifiChannelHelper Default (void);
   ...
   */
  Ptr<FullYansWifiChannel> Create (void) const;
  ...
  */
  int64_t AssignStreams (Ptr<FullYansWifiChannel> c, int64_t stream);
 ...
 *
 */
class FullYansWifiPhyHelper : public FullWifiPhyHelper,
...
public:
   ...
   */
  FullYansWifiPhyHelper ();

  /**
   * Create a phy helper in a default working state.
   */
  static FullYansWifiPhyHelper Default (void);
...
private:
   ...
   */
  virtual Ptr<FullWifiPhy> Create (Ptr<Node> node, Ptr<FullWifiNetDevice> device) const;
